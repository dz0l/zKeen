...
pub const APP_CONFIG: &str = "/opt/etc/xkeen/zkeen-ui.json";
pub const APP_CONFIG_LEGACY: &str = "/opt/etc/xkeen/xkeen-ui.json";
...
pub const ZKEEN_UI_LOG: &str = "/opt/var/log/zkeen-ui.log";
...
pub struct AppState {
    ...
    /// HTTP listen port of this panel process (from CLI `-p`).
    pub listen_port: u16,
}
