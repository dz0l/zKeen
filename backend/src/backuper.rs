...
const BACKUP_SUFFIX: &str = "zkeen-ui.tar";
const CONTENT_ORDER: [&str; 4] = ["xkeen", "zkeen-ui", "xray", "mihomo"];
...
struct BackupContentFiles {
    ...
    xkeen: Vec<String>,
    #[serde(rename = "zkeen-ui", skip_serializing_if = "Vec::is_empty")]
    xkeen_ui: Vec<String>,
    #[serde(skip_serializing_if = "Vec::is_empty")]
    xray: Vec<String>,
    #[serde(skip_serializing_if = "Vec::is_empty")]
...
impl BackupContentFiles {
    fn insert(&mut self, key: &str, file: String) {
        match key {
            ...
            "zkeen-ui" => self.xkeen_ui.push(file),
