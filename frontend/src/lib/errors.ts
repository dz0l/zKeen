...
const CODE_KEYS: Record<string, string> = {
  ...
  password_too_short: "settings.passwordTooShort",
  invalid_panel_port: "settings.portInvalid",
  panel_init_missing: "api.panelInitMissing",
  default_template_empty: "api.defaultTemplateEmpty",
  default_template_invalid: "api.defaultTemplateEmpty",
