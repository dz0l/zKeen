...
const translations: Translations = {
  ru: {
    ...
    "policies.newPolicySub": "Добавляет SRC-IP rule в config.yaml",
    ...
    "policies.proxyGroup": "Цель (группа / DIRECT)",
  ...
  en: {
    ...
    "policies.newPolicySub": "Adds SRC-IP rule to config.yaml",
    ...
    "policies.proxyGroup": "Target (group / DIRECT)",
